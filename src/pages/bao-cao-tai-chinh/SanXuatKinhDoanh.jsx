...
const SanXuatKinhDoanhPage = () => {
  ...
  const getPreviousMonthDates = () => {
    ...
    const lastDay = formatDateLocal(lastDayPrevMonth);
    return { firstDay: firstDayPrevMonth, lastDay };
  };
  ...
  const [ngayCt3, setNgayCt3] = useState(prevMonthDates.firstDay);
  const [ngayCt4, setNgayCt4] = useState(prevMonthDates.lastDay);
  ...
  const ngayCt3Ref = useRef(prevMonthDates.firstDay);
  const ngayCt4Ref = useRef(prevMonthDates.lastDay);
