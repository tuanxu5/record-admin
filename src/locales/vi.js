...
export const vi = {
  ...
  dashboard: {
    ...
    description: "Đây là trang báo cáo các thứ - Tổng hợp thông tin tài chính và hoạt động kinh doanh",
  ...
  sidebar: {
    dailyTransactions: "Giao dịch trong ngày",
    voucherListing: "Bảng kê chứng từ",
    totalIncome: "Tổng thu",
    totalExpense: "Tổng chi",
    workShifts: "Số ca làm việc",
    staffRewards: "Quà thưởng nhân viên",
    workTripPayments: "Số tiền chi trả theo công tác",
